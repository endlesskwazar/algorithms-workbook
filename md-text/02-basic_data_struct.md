...
Алгоритм являє собою набір команд для виконання якоїсь задачі. При цьому всі дані, які необхідні для рішення, організуються певним чином в так - звану **структуру даних**.
...
Залежно від пріоритету тих чи інших вимог вибирається спосіб реалізації.
