...
Найпростіша в реалізації послідовність проб - лінійне пробування (або лінійне дослідження). Тут все просто - в разі колізії, такі клітинки перевіряються лінійно, поки не буде знайдена порожня клітинка.

А алгоритм пошуку шукає клітинки в тому ж порядку, що і при вставці, поки не знайде потрібний елемент або вільну позицію, яка говорить про те, що ключ відсутній. У разі, якщо таблиця буде заповнена, її доведеться динамічно розширювати.
