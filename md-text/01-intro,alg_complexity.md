...
**Теорія алгоритмів** - наука, що знаходиться на стику математики та інформатики, що вивчає загальні властивості та закономірності алгоритмів і різноманітні формальні моделі їх подання.

Глибокі знання алгоритмів програмісту потрібно у двох випадках:
- Він хоче працювати в Google, Amazon, Microsoft і, або інші пафосні місця з великою кількістю охичих.
...
Погодьтесь визначення доволі просте, що може навести на думку, що розробка алгоритмів не є складним процесом. Але на практиці, алгоритми пишуться для вирішення складних задач.
...
- **Швидкість алгоритму.** Швидкий алгоритм чи ні? Чи є вхідні дані, які зменшують швидкість виконання?
...
- **збіжність** (закінченість, результативність) - алгоритм завжди закінчується за кінцеве число кроків
...
Напишім алгоритм і вирахуємо скільки часу він виконується:
...
- Час виконання був вирахований на певній машині із деякими характеристиками. Що буде, якщо цей алгоритм виконуватиметься на іншій машині з іншою конфігурацією?

На практиці, точний час мало кого цікавить: він залежить від процесора, типу даних, мови програмування і безлічі інших параметрів. Щоб перевірити ефективність алгоритму, програмісти відповідають на запитання: як зміниться продуктивність коду, якщо змінити розмірність задачі, що буде якщо збільшити у двічі розмір змінних в алгоритмі. У визначенні ефективності алгоритму важлива **асимптотична складність**, тобто. складність при прагненні розміру вхідних даних до нескінченності.

# Асимптотична складність.

Асимптотична складність (продуктивність) визначається функцією, яка вказує, наскільки погіршується робота алгоритму з ускладненням поставленої задачі. Таку функцію записують у круглих дужках, перед якою ставлять велику літеру О.
...
Оцінім складність наступного коду:
...
Оцінім складність наступного алгоритму:
...
У цьому алгоритмі змінна і змінюється від 1 до N. При кожній зміні i, змінна j теж змінюється від 1 до N. Під час кожної з N ітерацій зовнішнього циклу, внутрішній цикл теж виконується N раз. Загальна кількість ітерацій внутрішнього циклу одно N * N. Це визначає складність алгоритму $O(N^2)$.
...
**Множення двох функцій**. $O(f*g)= O(f) * O(g)$ - оцінка складності твори двох функцій дорівнює добутку їх складнощів, наприклад:
...
Розглянемо рекурсивну реалізацію обчислення факторіала:
...
Рекурсивний алгоритм, який викликає себе кілька разів, називається багаторазовою рекурсією. Такі процедури набагато складніше аналізувати, крім того, вони можуть зробити алгоритм набагато складніше.
...
Модифікуймо код і подивимося скільки насправді виконується функція:
...
В даному випадку середня й очікувана складність збігаються, але для багатьох алгоритмів найгірший випадок сильно відрізняється від очікуваного.
...
Багато алгоритмів пропонують вибір між обсягом пам'яті та швидкістю. Завдання можна вирішити швидко, використовую великий обсяг пам'яті, або повільніше, займаючи менший обсяг.
...
Результат буде отриманий миттєво, але це зажадає величезного обсягу пам'яті. Карта великого міста може містити десятки тисяч точок. Тоді, описана вище таблиця, повинна містити більше ніж 10 млрд записів. Тобто для того, щоб підвищити швидкодію алгоритму, необхідно використовувати додаткові 10 Гб пам'яті.
...
Ми будемо приділяти основну увагу тимчасової складності, але, однак, обов'язково будемо оскаржувати і обсяг споживаної пам'яті.
...
10. Розробіть алгоритм, який перевіряє чи всі числа на головній діагоналі матриці є однаковими. Порахуйте складність розробленого алгоритму.
